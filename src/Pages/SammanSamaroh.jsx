...
const data = [
  ...
  //   title: 'Cardiologist, AIIMS Delhi',
  ...
  //   title: 'Gynecologist, Fortis Hospital',
  ...
  // {
  //   name: 'Er. Arjun Rao',
  //   title: 'Civil Engineer, L&T',
  //   location: 'Hyderabad, India',
  //   tags: ['Engineer', 'B.Tech, M.Tech'],
  ...
  //   location: 'Pune, India',
  //   tags: ['Engineer', 'B.E., M.Tech'],
  //   image: 'https://randomuser.me/api/portraits/men/44.jpg',
  //   profession: 'Engineer',
  // },
  // {
  //   name: 'Mrs. Neeta Joshi',
  //   title: 'Social Worker, NGO India Cares',
  //   location: 'Lucknow, India',
  //   tags: ['Social Worker', 'MA, MSW'],
